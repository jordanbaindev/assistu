...
<template>
    <Html class="scroll-smooth">
        <Head>
            <Title>Virtual Assistant Services - AssistU</Title>

            <Meta name="description" content="Let us prove how much time and money a virtual assistant can save you."></Meta>
            <Meta name="robots" content="index,follow"></Meta>
            <Link href="https://assistyou.online"></Link>
        ...
        <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
            ...
            <p class="text-center text-base text-gray-400">&copy; 2022 AssistU, Inc. All rights reserved.</p>
            </div>
        </div>
        </footer>
    </Html>
