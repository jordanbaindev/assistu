<template>
    <div class="relative py-8 bg-amber-50">
      <div class="hidden absolute top-0 inset-x-0 h-1/2 bg-amber-50 lg:block" aria-hidden="true" />
      <div class="max-w-7xl mx-auto bg-indigo-600 lg:bg-transparent lg:px-8">
        <div class="lg:grid lg:grid-cols-12">
          <div class="relative z-10 lg:col-start-1 lg:row-start-1 lg:col-span-4 lg:py-16 lg:bg-transparent">
            <div class="absolute inset-x-0 h-1/2 bg-amber-50 lg:hidden" aria-hidden="true" />
          ...
          <div class="relative bg-indigo-600 lg:col-start-3 lg:row-start-1 lg:col-span-10 lg:rounded-3xl lg:grid lg:grid-cols-10 lg:items-center">
            ...
            <div class="relative max-w-md mx-auto py-12 px-4 space-y-6 sm:max-w-3xl sm:py-16 sm:px-6 lg:max-w-none lg:p-0 lg:col-start-4 lg:col-span-6">
              <h2 class="text-3xl font-extrabold text-amber-200" id="join-heading">Sit back, relax and enjoy coffee.</h2>
              <p class="text-lg text-white">Your inbox is overflowing, your appointments are a mess, you have travel that needs booking, and your "to do" list is endless. VA's have all of the skills to handle both your work and personal needs, and can start relieving your stress immediately.</p>
              <!-- <a class="block w-full py-3 px-5 text-center bg-white border border-transparent rounded-md shadow-md text-base font-medium text-indigo-700 hover:bg-gray-50 sm:inline-block sm:w-auto" href="#">Contact Us Today</a> -->
            </div>
          </div>
        </div>
      </div>
